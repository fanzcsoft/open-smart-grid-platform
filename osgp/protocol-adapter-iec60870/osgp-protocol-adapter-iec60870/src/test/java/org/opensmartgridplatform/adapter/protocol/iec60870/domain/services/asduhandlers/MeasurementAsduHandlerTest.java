...
public class MeasurementAsduHandlerTest {
  ...
  public void shouldSendMeasurementReportAndLogItemWhenHandlingAsdu() throws Exception {
    ...
    final LogItem logItem =
        new LogItem(DEVICE_IDENTIFICATION, ORGANISATION_IDENTIFICATION, true, asdu.toString());

    when(this.responseMetadataFactory.createWithNewCorrelationUid(responseMetadata))

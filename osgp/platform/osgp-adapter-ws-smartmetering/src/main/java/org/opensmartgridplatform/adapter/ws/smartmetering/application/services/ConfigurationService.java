...
public class ConfigurationService {
  ...
  public String requestSetAdministrativeStatus(
      final String organisationIdentification,
      final String deviceIdentification,
      final AdministrativeStatusType requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
        organisationIdentification,
        deviceIdentification,
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_ADMINISTRATIVE_STATUS,
  ...
  public String enqueueGetFirmwareRequest(
      ...
      final GetFirmwareVersionQuery requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
  ...
  public String enqueueUpdateFirmwareRequest(
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.UPDATE_FIRMWARE,
        MessageType.UPDATE_FIRMWARE,
        updateFirmwareRequestData);
  }

  public String requestGetAdministrativeStatus(
      final String organisationIdentification,
      final String deviceIdentification,
      final int messagePriority,
      final Long scheduleTime)
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.GET_ADMINISTRATIVE_STATUS,
        MessageType.GET_ADMINISTRATIVE_STATUS,
        AdministrativeStatusType.UNDEFINED);
  }

  public String enqueueSetSpecialDaysRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final SpecialDaysRequest requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_SPECIAL_DAYS,
        MessageType.SET_SPECIAL_DAYS,
        requestData);
  }

  public String enqueueSetConfigurationObjectRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final SetConfigurationObjectRequest requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_CONFIGURATION_OBJECT,
        MessageType.SET_CONFIGURATION_OBJECT,
        requestData);
  }

  public String enqueueSetPushSetupAlarmRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_PUSH_SETUP_ALARM,
        MessageType.SET_PUSH_SETUP_ALARM,
        pushSetupAlarm);
  }

  public String enqueueSetPushSetupSmsRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_PUSH_SETUP_SMS,
        MessageType.SET_PUSH_SETUP_SMS,
        pushSetupSms);
  }

  public String enqueueSetAlarmNotificationsRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final AlarmNotifications alarmSwitches,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_ALARM_NOTIFICATIONS,
  ...
  public String enqueueGetMbusEncryptionKeyStatusRequest(
      final String organisationIdentification,
      final String deviceIdentification,
      final int messagePriority,
      final Long scheduleTime)
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.GET_MBUS_ENCRYPTION_KEY_STATUS,
        MessageType.GET_MBUS_ENCRYPTION_KEY_STATUS,
        null);
  }

  public String enqueueGetMbusEncryptionKeyStatusByChannelRequest(
      final String organisationIdentification,
      final String deviceIdentification,
      final int messagePriority,
      final Long scheduleTime,
  ...
  public String enqueueSetActivityCalendarRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_ACTIVITY_CALENDAR,
        MessageType.SET_ACTIVITY_CALENDAR,
        activityCalendar);
  }

  public String enqueueReplaceKeysRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final SetKeysRequestData keySet,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.REPLACE_KEYS,
        MessageType.REPLACE_KEYS,
        keySet);
  }

  public String enqueueSetClockConfigurationRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final SetClockConfigurationRequestData clockConfigurationRequestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_CLOCK_CONFIGURATION,
        MessageType.SET_CLOCK_CONFIGURATION,
        clockConfigurationRequestData);
  }

  public String enqueueGetConfigurationObjectRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final GetConfigurationObjectRequest requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.GET_CONFIGURATION_OBJECT,
        MessageType.GET_CONFIGURATION_OBJECT,
        requestData);
  }

  public String enqueueGenerateAndReplaceKeysRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final int messagePriority,
      final Long scheduleTime)
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.GENERATE_AND_REPLACE_KEYS,
        MessageType.GENERATE_AND_REPLACE_KEYS,
        null);
  }

  public String enqueueConfigureDefinableLoadProfileRequest(
      final String organisationIdentification,
      final String deviceIdentification,
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.CONFIGURE_DEFINABLE_LOAD_PROFILE,
        MessageType.CONFIGURE_DEFINABLE_LOAD_PROFILE,
        definableLoadProfileConfigurationData);
  }

  public String enqueueSetMbusUserKeyByChannelRequest(
      final String organisationIdentification,
      final String deviceIdentification,
    ...
    return this.enqueueAndSendRequest(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.SET_MBUS_USER_KEY_BY_CHANNEL,
        MessageType.SET_MBUS_USER_KEY_BY_CHANNEL,
        setMbusUserKeyByChannelRequestData);
  }

  public String enqueueSetRandomisationSettingsRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final SetRandomisationSettingsRequest requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    return this.enqueueAndSendRequest(
  ...
  /**
   * Checks if the organization (identified by the organisationIdentification) is allowed to execute
   * this function. Creates a correlation id, sends the request from the ws-adapter to the
   * domain-adapter and returns the correlation id.
   *
   * @param organisationIdentification {@link String} containing the organization identification
   * @param deviceIdentification {@link String} containing the device identification for the given
   *     device
   * @param messagePriority contains the message priority
   * @param scheduleTime contains the time when the message is scheduled to be executed
   * @param deviceFunction used to check if the organisation is allowed to execute this request on
   *     the given device
   * @param messageType messageType is added to the message metadata
   * @param requestObject contains request data if applicable
   * @return the correlation id belonging to the request
   * @throws FunctionalException is thrown when either the device or organization cannot be found or
   *     the organization is not allowed to execute the function
   */
  private String enqueueAndSendRequest(
      final String organisationIdentification,
      final String deviceIdentification,
      final int messagePriority,
      final Long scheduleTime,
      ...
      throws FunctionalException {
    log.debug(
        "enqueueAndSendRequest called for messageType {} with organisation {} and device {}",
        messageType,
        organisationIdentification,
        deviceIdentification);

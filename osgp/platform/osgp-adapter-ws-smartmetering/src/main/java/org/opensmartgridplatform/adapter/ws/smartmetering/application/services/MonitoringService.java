...
public class MonitoringService {
  ...
  public String enqueuePeriodicMeterReadsRequestData(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final PeriodicMeterReadsQuery requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {

    return this.enqueueRequestData(
  ...
  public String enqueueActualMeterReadsRequestData(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final ActualMeterReadsQuery requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    ...
    return this.enqueueRequestData(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.REQUEST_ACTUAL_METER_DATA,
        MessageType.REQUEST_ACTUAL_METER_DATA);
  }

  public String enqueueReadAlarmRegisterRequestData(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final ReadAlarmRegisterRequest requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    ...
    return this.enqueueRequestData(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.READ_ALARM_REGISTER,
        MessageType.READ_ALARM_REGISTER);
  }

  public String enqueueGetPowerQualityProfileRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    return this.enqueueRequestData(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.GET_PROFILE_GENERIC_DATA,
  ...
  public ResponseData dequeueGetPowerQualityProfileDataResponseData(final String correlationUid)
    ...
    return this.responseDataService.dequeue(
        correlationUid, GetPowerQualityProfileResponse.class, ComponentType.WS_SMART_METERING);
  }

  public String enqueueClearAlarmRegisterRequestData(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final ClearAlarmRegisterRequest requestData,
      final int messagePriority,
      final Long scheduleTime)
      throws FunctionalException {
    ...
    return this.enqueueRequestData(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.CLEAR_ALARM_REGISTER,
        MessageType.CLEAR_ALARM_REGISTER);
  }

  public String enqueueActualPowerQualityRequestData(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    return this.enqueueRequestData(
        ...
        messagePriority,
        scheduleTime,
        DeviceFunction.GET_ACTUAL_POWER_QUALITY,
        MessageType.GET_ACTUAL_POWER_QUALITY);
  }

  private String enqueueRequestData(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    if (log.isDebugEnabled()) {
      log.debug(
          "Enqueue {} request data called with organisation {} and device {}",
          messageType.name().toLowerCase().replace('_', ' '),
          organisationIdentification,
          deviceIdentification);
    }

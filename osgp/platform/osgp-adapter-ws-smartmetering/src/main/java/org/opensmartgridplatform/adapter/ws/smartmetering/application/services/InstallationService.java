...
public class InstallationService {
  ...
  public String enqueueAddSmartMeterRequest(
    ...
    log.debug(
        "enqueueAddSmartMeterRequest called with organisation {} and device {}",
   ...
   * @param deviceIdentification the identification of the gateway device
   * @param mbusDeviceIdentification the identification of the m-bus device
   * @param messagePriority the priority of the message
   * @param scheduleTime the time the request should be carried out
   * @return the correlationUid identifying the operation
   */
  public String enqueueCoupleMbusDeviceRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      @Identification final String mbusDeviceIdentification,
      final int messagePriority,
      final Long scheduleTime)
    ...
    log.debug(
        "enqueueCoupleMbusDeviceRequest called with organisation {}, gateway {} and mbus device {}",
        organisationIdentification,
        deviceIdentification,
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.COUPLE_MBUS_DEVICE.name(),
            messagePriority,
            scheduleTime);
    ...
    final CoupleMbusDeviceRequestData coupleMbusDeviceRequestData =
        new CoupleMbusDeviceRequestData(mbusDeviceIdentification);
  ...
  /**
   * @param organisationIdentification the organisation requesting the decoupling of devices
   * @param deviceIdentification the identification of the gateway device
   * @param mbusDeviceIdentification the identification of the m-bus device
   * @param messagePriority the priority of the message
   * @param scheduleTime the time the request should be carried out
   * @return the correlationUid identifying the operation
   */
  public String enqueueDecoupleMbusDeviceRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      @Identification final String mbusDeviceIdentification,
      final int messagePriority,
    ...
    this.domainHelperService.checkAllowed(
        organisation, device, DeviceFunction.DECOUPLE_MBUS_DEVICE);

    log.debug(
        "enqueueDecoupleMbusDeviceRequest called with organisation {}, gateway {} and mbus device {}",
        organisationIdentification,
        deviceIdentification,
        mbusDeviceIdentification);
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.DECOUPLE_MBUS_DEVICE.name(),
            messagePriority,
            scheduleTime);
   ...
   * @return the correlationUid identifying the operation
   */
  public String enqueueCoupleMbusDeviceByChannelRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final int messagePriority,
      final Long scheduleTime,
    ...
    this.domainHelperService.checkAllowed(
        organisation, device, DeviceFunction.COUPLE_MBUS_DEVICE_BY_CHANNEL);

    log.debug(
        "enqueueCoupleMbusDeviceByChannelRequest called with organisation {}, gateway {}",
        organisationIdentification,
        deviceIdentification);
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.COUPLE_MBUS_DEVICE_BY_CHANNEL.name(),
            messagePriority,
            scheduleTime);
   ...
   * @param messagePriority the priority of the message
   * @param scheduleTime the time the request should be carried out
   * @param channel the channel on the gateway device that should be cleared (decoupled)
   * @return the correlationUid identifying the operation
   */
  public String enqueueDecoupleMbusDeviceByChannelRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final int messagePriority,
      final Long scheduleTime,
    ...
    this.domainHelperService.checkAllowed(
        organisation, device, DeviceFunction.DECOUPLE_MBUS_DEVICE_BY_CHANNEL);

    log.debug(
        "enqueueDecoupleMbusDeviceByChannelRequest called with organisation {}, gateway {}",
        organisationIdentification,
        deviceIdentification);
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.DECOUPLE_MBUS_DEVICE_BY_CHANNEL.name(),
            messagePriority,
            scheduleTime);

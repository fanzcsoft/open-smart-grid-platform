...
public class SmartMeteringAdhocEndpoint extends SmartMeteringEndpoint {
  ...
  public SynchronizeTimeAsyncResponse synchronizeTime(
    ...
    final String correlationUid =
        this.adhocService.enqueueSynchronizeTimeRequest(
  ...
  public GetAllAttributeValuesAsyncResponse getAllAttributeValues(
    ...
    final String correlationUid =
        this.adhocService.enqueueGetAllAttributeValuesRequest(
            organisationIdentification,
            getAllAttributeValuesRequest.getDeviceIdentification(),
            getAllAttributeValuesRequest,
            MessagePriorityEnum.getMessagePriority(messagePriority),
            this.adhocMapper.map(scheduleTime, Long.class));
  ...
  public GetSpecificAttributeValueAsyncResponse getSpecificAttributeValue(
    ...
    final GetSpecificAttributeValueAsyncResponse response =
        new GetSpecificAttributeValueAsyncResponse();
    ...
    final String correlationUid =
        this.adhocService.enqueueSpecificAttributeValueRequest(
            organisationIdentification,
            request.getDeviceIdentification(),
            getSpecificAttributeValueRequest,
            MessagePriorityEnum.getMessagePriority(messagePriority),
  ...
  public GetAssociationLnObjectsAsyncResponse getAssociationLnObjects(
    ...
    final GetAssociationLnObjectsAsyncResponse response =
        new GetAssociationLnObjectsAsyncResponse();
    ...
    final String correlationUid =
        this.adhocService.enqueueGetAssociationLnObjectsRequest(
            organisationIdentification,
            getAssociationLnObjectsRequest.getDeviceIdentification(),
            getAssociationLnObjectsRequest,
            MessagePriorityEnum.getMessagePriority(messagePriority),
            this.adhocMapper.map(scheduleTime, Long.class));
  ...
  public ScanMbusChannelsAsyncResponse scanMbusChannels(
    ...
    final String correlationUid =
        this.adhocService.enqueueScanMbusChannelsRequest(
            organisationIdentification,
            request.getDeviceIdentification(),
            scanMbusChannelsRequest,
            MessagePriorityEnum.getMessagePriority(messagePriority),

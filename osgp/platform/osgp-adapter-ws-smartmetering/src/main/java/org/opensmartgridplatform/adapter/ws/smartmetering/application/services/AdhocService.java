...
public class AdhocService {
  ...
  public String enqueueSynchronizeTimeRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
      final SynchronizeTimeRequestData utcOffset,
    ...
    LOGGER.debug(
        "enqueueSynchronizeTimeRequest called with organisation {} and device {}",
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.SYNCHRONIZE_TIME.name(),
            messagePriority,
            scheduleTime);
  ...
  public String enqueueGetAllAttributeValuesRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    this.domainHelperService.checkAllowed(
        organisation, device, DeviceFunction.GET_ALL_ATTRIBUTE_VALUES);

    LOGGER.debug(
        "enqueueGetAllAttributeValuesRequest called with organisation {} and device {}",
        organisationIdentification,
        deviceIdentification);
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.GET_ALL_ATTRIBUTE_VALUES.name(),
            messagePriority,
            scheduleTime);
  ...
  public String enqueueGetAssociationLnObjectsRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    this.domainHelperService.checkAllowed(
        organisation, device, DeviceFunction.GET_ASSOCIATION_LN_OBJECTS);

    LOGGER.debug(
        "enqueueGetAssociationLnObjectsRequest called with organisation {} and device {}",
        organisationIdentification,
        deviceIdentification);
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.GET_ASSOCIATION_LN_OBJECTS.name(),
            messagePriority,
            scheduleTime);
  ...
  public String enqueueSpecificAttributeValueRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    this.domainHelperService.checkAllowed(
        organisation, device, DeviceFunction.GET_SPECIFIC_ATTRIBUTE_VALUE);

    LOGGER.debug(
        "enqueueSpecificAttributeValueRequest called with organisation {} and device {}",
        organisationIdentification,
        deviceIdentification);
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.GET_SPECIFIC_ATTRIBUTE_VALUE.name(),
            messagePriority,
            scheduleTime);
  ...
  public String enqueueScanMbusChannelsRequest(
      @Identification final String organisationIdentification,
      @Identification final String deviceIdentification,
    ...
    LOGGER.debug(
        "enqueueScanMbusChannelsRequest called with organisation {} and device {}",
        organisationIdentification,
        deviceIdentification);
    ...
    final DeviceMessageMetadata deviceMessageMetadata =
        new DeviceMessageMetadata(
            ...
            organisationIdentification,
            correlationUid,
            MessageType.SCAN_MBUS_CHANNELS.name(),
            messagePriority,
            scheduleTime);

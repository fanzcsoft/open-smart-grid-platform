...
public class SmartMeteringInstallationEndpoint extends SmartMeteringEndpoint {
  ...
  public AddDeviceAsyncResponse addDevice(
    ...
    try {
      ...
      final String correlationUid =
          this.installationService.enqueueAddSmartMeterRequest(
  ...
  public CoupleMbusDeviceAsyncResponse coupleMbusDevice(
    ...
    log.info(
        "Incoming CoupleMbusDeviceRequest for meter: {} and mbus device {}.",
    ...
    try {
      ...
      final String correlationUid =
          this.installationService.enqueueCoupleMbusDeviceRequest(
              organisationIdentification,
              deviceIdentification,
              mbusDeviceIdentification,
              MessagePriorityEnum.getMessagePriority(messagePriority),
      ...
      log.error(
          "Exception while coupling devices: {} and {} for organisation {}.",
          deviceIdentification,
          mbusDeviceIdentification,
          organisationIdentification,
          e);
  ...
  public DecoupleMbusDeviceAsyncResponse decoupleMbusDevice(
    ...
    final String mbusDeviceIdentification = request.getMbusDeviceIdentification();
    log.info(
        "Incoming DecoupleMbusDeviceRequest for meter: {} and mbus device {}.",
        deviceIdentification,
        mbusDeviceIdentification);
    ...
    try {
      ...
      final String correlationUid =
          this.installationService.enqueueDecoupleMbusDeviceRequest(
              organisationIdentification,
              deviceIdentification,
              mbusDeviceIdentification,
              MessagePriorityEnum.getMessagePriority(messagePriority),
      ...
      log.error(
          "Exception: {} while decoupling devices: {} and {} for organisation {}.",
          e.getMessage(),
          deviceIdentification,
          mbusDeviceIdentification,
          organisationIdentification,
  ...
  public CoupleMbusDeviceByChannelAsyncResponse coupleMbusDeviceByChannel(
    ...
    log.info(
        "Incoming CoupleMbusDeviceByChannelRequest for device: {} and channel {}.",
        deviceIdentification,
        channel);
    ...
    try {
      ...
      final String correlationUid =
          this.installationService.enqueueCoupleMbusDeviceByChannelRequest(
              organisationIdentification,
              deviceIdentification,
              MessagePriorityEnum.getMessagePriority(messagePriority),
              this.installationMapper.map(scheduleTime, Long.class),
      ...
      log.error(
          "Exception while coupling on channel: {} for device: {} for organisation {}.",
          channel,
          deviceIdentification,
          organisationIdentification,
          e);
  ...
  public DecoupleMbusDeviceByChannelAsyncResponse decoupleMbusDeviceByChannel(
    ...
    log.info(
        "Incoming DecoupleMbusDeviceByChannelRequest for device: {} and channel {}.",
        deviceIdentification,
        channel);
    ...
    try {
      ...
      final String correlationUid =
          this.installationService.enqueueDecoupleMbusDeviceByChannelRequest(
              organisationIdentification,
              deviceIdentification,
              MessagePriorityEnum.getMessagePriority(messagePriority),
              this.installationMapper.map(scheduleTime, Long.class),
      ...
      log.error(
          "Exception while cleaning up on channel: {} for device: {} for organisation {}.",
          channel,
          deviceIdentification,
          organisationIdentification,
          e);

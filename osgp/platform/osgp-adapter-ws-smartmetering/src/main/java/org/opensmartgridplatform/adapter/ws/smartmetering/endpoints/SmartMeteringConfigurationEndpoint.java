...
public class SmartMeteringConfigurationEndpoint extends SmartMeteringEndpoint {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SmartMeteringConfigurationEndpoint.class);
  ...
  public GetFirmwareVersionAsyncResponse getFirmwareVersion(
    ...
    LOGGER.info(
        "GetFirmwareVersion Request received from organisation {} for device {}.",
    ...
    return (GetFirmwareVersionAsyncResponse)
        this.handleGetFirmwareVersion(
            organisationIdentification,
            deviceIdentification,
            new GetFirmwareVersionQuery(),
            messagePriority,
            scheduleTime,
            responseUrl,
            response);
  ...
  public GetFirmwareVersionGasAsyncResponse getFirmwareVersionGas(
    ...
    LOGGER.info(
        "GetFirmwareVersionGasRequest received from organisation {} for device {}.",
        organisationIdentification,
        deviceIdentification);
    ...
    return (GetFirmwareVersionGasAsyncResponse)
        this.handleGetFirmwareVersion(
            organisationIdentification,
            deviceIdentification,
            new GetFirmwareVersionQuery(true),
            messagePriority,
            scheduleTime,
            responseUrl,
            response);
  ...
  private AsyncResponse handleGetFirmwareVersion(
      final String organisationIdentification,
      final String deviceIdentification,
      final GetFirmwareVersionQuery firmwareVersionQuery,
    ...
    try {
      final String correlationUid =
          this.configurationService.enqueueGetFirmwareRequest(
              organisationIdentification,
              deviceIdentification,
  ...
  public UpdateFirmwareAsyncResponse updateFirmware(
    ...
    LOGGER.info(
        "UpdateFirmware Request received from organisation {} for device {}.",
        organisationIdentification,
        request.getDeviceIdentification());
    ...
    try {
      ...
      final String correlationUid =
          this.configurationService.enqueueUpdateFirmwareRequest(
              organisationIdentification,
              request.getDeviceIdentification(),
              updateFirmwareRequestData,
              MessagePriorityEnum.getMessagePriority(messagePriority),
              this.configurationMapper.map(scheduleTime, Long.class));
  ...
  public GetAdministrativeStatusAsyncResponse getAdministrativeStatus(
    ...
    final String correlationUid =
        this.configurationService.requestGetAdministrativeStatus(
            organisationIdentification,
            request.getDeviceIdentification(),
            MessagePriorityEnum.getMessagePriority(messagePriority),
            this.configurationMapper.map(scheduleTime, Long.class));

    final GetAdministrativeStatusAsyncResponse asyncResponse =
        new GetAdministrativeStatusAsyncResponse();
  ...
  public SetSpecialDaysAsyncResponse setSpecialDaysData(
    ...
    final String correlationUid =
        this.configurationService.enqueueSetSpecialDaysRequest(
            organisationIdentification,
            dataRequest.getDeviceIdentification(),
            dataRequest,
            MessagePriorityEnum.getMessagePriority(messagePriority),
            this.configurationMapper.map(scheduleTime, Long.class));
  ...
  public SetConfigurationObjectAsyncResponse setConfigurationObject(
    ...
    final String correlationUid =
        this.configurationService.enqueueSetConfigurationObjectRequest(
            organisationIdentification,
            dataRequest.getDeviceIdentification(),
            dataRequest,
            MessagePriorityEnum.getMessagePriority(messagePriority),
  ...
  public SetEncryptionKeyExchangeOnGMeterAsyncResponse setEncryptionKeyExchangeOnGMeter(
    ...
    LOGGER.info(
        "Incoming SetEncryptionKeyExchangeOnGMeterRequest for meter: {}.",
        request.getDeviceIdentification());
    ...
    try {
      ...
      final String correlationUid =
          this.configurationService.enqueueSetEncryptionKeyExchangeOnGMeterRequest(
              organisationIdentification,
              deviceIdentification,
              MessagePriorityEnum.getMessagePriority(messagePriority),
              this.configurationMapper.map(scheduleTime, Long.class));
  ...
  public GetMbusEncryptionKeyStatusAsyncResponse getMbusEncryptionKeyStatus(
    ...
    LOGGER.info(
        "Get M-Bus encryption key status request received from organisation {} for device {}",
        organisationIdentification,
        request.getDeviceIdentification());
    ...
    try {
      final String correlationUid =
          this.configurationService.enqueueGetMbusEncryptionKeyStatusRequest(
              organisationIdentification,
              request.getDeviceIdentification(),
              MessagePriorityEnum.getMessagePriority(messagePriority),
              this.configurationMapper.map(scheduleTime, Long.class));
  ...
  public GetMbusEncryptionKeyStatusByChannelAsyncResponse getMbusEncryptionKeyStatusByChannel(
    ...
    LOGGER.info(
        "Get M-Bus encryption key status by channel request received from organisation {} for device {}",
        organisationIdentification,
    ...
    try {
      final String correlationUid =
          this.configurationService.enqueueGetMbusEncryptionKeyStatusByChannelRequest(
              organisationIdentification,
              request.getGatewayDeviceIdentification(),
              MessagePriorityEnum.getMessagePriority(messagePriority),
              this.configurationMapper.map(scheduleTime, Long.class),
  ...
  public SetPushSetupAlarmAsyncResponse setPushSetupAlarm(
    ...
    LOGGER.info(
        "Incoming SetPushSetupAlarmRequest for meter: {}.", request.getDeviceIdentification());
    ...
    final String correlationUid =
        this.configurationService.enqueueSetPushSetupAlarmRequest(
            organisationIdentification,
            deviceIdentification,
            pushSetupAlarm,
            MessagePriorityEnum.getMessagePriority(messagePriority),
  ...
  public SetPushSetupSmsAsyncResponse setPushSetupSms(
    ...
    LOGGER.info(
        "Incoming SetPushSetupSmsRequest for meter: {}.", request.getDeviceIdentification());
    ...
    final String correlationUid =
        this.configurationService.enqueueSetPushSetupSmsRequest(
            organisationIdentification,
            deviceIdentification,
            pushSetupSms,
            MessagePriorityEnum.getMessagePriority(messagePriority),
  ...
  public SetActivityCalendarAsyncResponse setActivityCalendar(
    ...
    LOGGER.info(
        "Incoming SetActivityCalendarRequest for meter: {}.", request.getDeviceIdentification());
    ...
    try {
      ...
      final ActivityCalendar activityCalendar =
          this.configurationMapper.map(requestData.getActivityCalendar(), ActivityCalendar.class);

      final String correlationUid =
          this.configurationService.enqueueSetActivityCalendarRequest(
              organisationIdentification,
              deviceIdentification,
              activityCalendar,
              MessagePriorityEnum.getMessagePriority(messagePriority),
      ...
      LOGGER.error(
          "Exception: {} while setting activity calendar on device: {} for organisation {}.",
          e.getMessage(),
          request.getDeviceIdentification(),
          organisationIdentification,
          e);
  ...
  public SetAlarmNotificationsAsyncResponse setAlarmNotifications(
    ...
    LOGGER.info(
        "Incoming SetAlarmNotificationsRequest for meter: {}.", request.getDeviceIdentification());

    SetAlarmNotificationsAsyncResponse response = null;
    try {
      response = new SetAlarmNotificationsAsyncResponse();
      final String deviceIdentification = request.getDeviceIdentification();
      final SetAlarmNotificationsRequestData requestData =
          request.getSetAlarmNotificationsRequestData();
      ...
      final String correlationUid =
          this.configurationService.enqueueSetAlarmNotificationsRequest(
              organisationIdentification,
              deviceIdentification,
              alarmNotifications,
              MessagePriorityEnum.getMessagePriority(messagePriority),
      ...
      LOGGER.error(
          "Exception: {} while setting alarm notifications on device: {} for organisation {}.",
          e.getMessage(),
          request.getDeviceIdentification(),
          organisationIdentification,
          e);
  ...
  public ReplaceKeysAsyncResponse replaceKeys(
    ...
    try {
      ...
      final String correlationUid =
          this.configurationService.enqueueReplaceKeysRequest(
              organisationIdentification,
              request.getDeviceIdentification(),
              keySet,
              MessagePriorityEnum.getMessagePriority(messagePriority),
  ...
  public GenerateAndReplaceKeysAsyncResponse generateAndReplaceKeys(
    ...
    try {
      LOGGER.info(
          "Generate and replace keys request received from organisation {} for device {}.",
          organisationIdentification,
          request.getDeviceIdentification());

      final String correlationUid =
          this.configurationService.enqueueGenerateAndReplaceKeysRequest(
              organisationIdentification,
              request.getDeviceIdentification(),
              MessagePriorityEnum.getMessagePriority(messagePriority),
              this.configurationMapper.map(scheduleTime, Long.class));
  ...
  public SetClockConfigurationAsyncResponse setClockConfiguration(
    ...
    try {
      ...
      final String correlationUid =
          this.configurationService.enqueueSetClockConfigurationRequest(
              organisationIdentification,
              request.getDeviceIdentification(),
              clockConfiguration,
              MessagePriorityEnum.getMessagePriority(messagePriority),
  ...
  public GetConfigurationObjectAsyncResponse getConfigurationObject(
    ...
    final String correlationUid =
        this.configurationService.enqueueGetConfigurationObjectRequest(
            organisationIdentification,
            dataRequest.getDeviceIdentification(),
            dataRequest,
            MessagePriorityEnum.getMessagePriority(messagePriority),
  ...
  public ConfigureDefinableLoadProfileAsyncResponse configureDefinableLoadProfile(
    ...
    try {
      ...
      final String correlationUid =
          this.configurationService.enqueueConfigureDefinableLoadProfileRequest(
              organisationIdentification,
              request.getDeviceIdentification(),
              definableLoadProfileConfiguration,
              MessagePriorityEnum.getMessagePriority(messagePriority),
  ...
  public SetMbusUserKeyByChannelAsyncResponse setMbusUserKeyByChannel(
    ...
    LOGGER.info(
        "Incoming SetMbusUserKeyByChannelRequest for gateway: {}.",
        request.getDeviceIdentification());
    ...
    try {
      ...
      final String correlationUid =
          this.configurationService.enqueueSetMbusUserKeyByChannelRequest(
              organisationIdentification,
              deviceIdentification,
  ...
  public SetRandomisationSettingsAsyncResponse setRandomisationSettings(
    ...
    final SetRandomisationSettingsAsyncResponse response =
        new SetRandomisationSettingsAsyncResponse();

    final org.opensmartgridplatform.domain.core.valueobjects.smartmetering
            .SetRandomisationSettingsRequest
        dataRequest =
            this.configurationMapper.map(
                request,
                org.opensmartgridplatform.domain.core.valueobjects.smartmetering
                    .SetRandomisationSettingsRequest.class);

    final String correlationUid =
        this.configurationService.enqueueSetRandomisationSettingsRequest(
            organisationIdentification,
            dataRequest.getDeviceIdentification(),
            dataRequest,
            MessagePriorityEnum.getMessagePriority(messagePriority),

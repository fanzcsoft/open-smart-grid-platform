...
public class JmsPropertyReaderTest {
  ...
  private static final String PROPERTY_PREFIX = "jms.test";

  private static final String DEFAULT_QUEUE = "default-queue";
  private static final boolean DEFAULT_USE_BACKOFF = true;

  private static final String CUSTOM_QUEUE = "custom-queue";
  private static final boolean CUSTOM_USE_BACKOFF = false;

...
public class XMLGregorianCalendarToZonedDateTimeConverterTest {
  ...
  /**
   * Register {@link XMLGregorianCalendarToZonedDateTimeConverter} and {@link
   * ZonedDateTimeToStringConverter}. The former is the class under test. The latter is just part of
   * the unit tests.
   */
  @BeforeEach
  public void before() {
